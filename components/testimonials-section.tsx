...
const testimonials = [
  {
    name: "John Carter",
    role: "Member, Marquette HS Chapter",
    content:
      "BFN gave me a clear path into finance — the resources and competitions helped me land my first internship.",
    avatar: "/placeholder.svg?height=48&width=48",
  },
  {
    name: "Sophie Moore",
    role: "Chapter Lead, Middleton HS",
    content: "Leading a chapter taught me more about finance and leadership than any class ever could.",
    avatar: "/placeholder.svg?height=48&width=48",
  },
  {
    name: "Matt Cannon",
    role: "Member, Bridgewater-Raritan HS",
    content: "The curated opportunities and deadlines kept me organized and ahead of every application.",
    avatar: "/placeholder.svg?height=48&width=48",
  },
]
