...
export default function Footer() {
  return (
    <footer className="bg-[oklch(0.12_0.03_260)] text-white/70">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="text-white/40 hover:text-[oklch(0.75_0.15_175)] transition-colors"
            >
            ...
            <a
              ...
              className="text-white/40 hover:text-[oklch(0.75_0.15_175)] transition-colors text-xs"
            >
