      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                Connected
                <br />
                <span className="text-foreground/40">nationally.</span>
              </h2>
            </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "200+", label: "Student Members", sublabel: "And growing", direction: "right" },
              { value: "4", label: "Coverage Desks", sublabel: "Banking, Research, Markets, PE", direction: "left" },
              { value: "4", label: "Member Paths", sublabel: "Learn, Find, Practice, Lead", direction: "right" },
            ].map((stat, i) => {
