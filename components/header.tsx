    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "px-4 pt-4" : ""}`}>
      <div
        className={`max-w-7xl mx-auto transition-all duration-300 ${
          isScrolled
            ? "bg-white backdrop-blur-xl rounded-2xl border border-zinc-200 px-6 py-3"
          ...
          <div className="hidden md:flex items-center gap-1">
            <a
              ...
              className={`px-5 py-2.5 text-sm transition-colors ${
                isScrolled ? "text-black hover:text-zinc-600" : "text-foreground hover:text-muted-foreground"
              }`}
            >
              Member Login
            </a>
