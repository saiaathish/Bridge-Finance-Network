            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={item.step}
                    className={`relative p-7 rounded-xl bg-white border border-[oklch(0.92_0.005_260)] transition-all duration-500 hover:-translate-y-1 ${
                      isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                    }`}
                    style={{ transitionDelay: `${400 + i * 100}ms` }}
                  >
                    <div className="w-10 h-10 rounded-full bg-[oklch(0.75_0.15_175/0.1)] flex items-center justify-center mb-4">
                      <span className="font-display text-sm font-bold text-[oklch(0.65_0.15_175)]">{item.step}</span>
                    </div>
